          ...
          <Dialog open={!!selectedCatchId} onOpenChange={() => setSelectedCatchId(null)}>
            <DialogContent className="max-w-xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  View detailed information about this catch
                </DialogDescription>
              </DialogHeader>
              
              {allCatches.filter(c => c.id === selectedCatchId).map((catchItem: any) => {
                const speciesInfo = getFishSpeciesById(catchItem.species);
                return (
                  <div key={catchItem.id} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <h3 className="text-sm font-medium mb-1">Species</h3>
                        <p>{speciesInfo?.name || catchItem.species}</p>
                      </div>
                      <div>
                        <h3 className="text-sm font-medium mb-1">Size</h3>
                        <p>{catchItem.size} inches</p>
                      </div>
                      <div>
                        <h3 className="text-sm font-medium mb-1">Weight</h3>
                        <p>{catchItem.weight ? `${catchItem.weight} lbs` : 'Not recorded'}</p>
                      </div>
                      <div>
                        ...
                        <p>
                          ...
                          (catchItem.latitude && catchItem.longitude 
                            ? `${catchItem.latitude.toFixed(4)}, ${catchItem.longitude.toFixed(4)}` 
                            : 'Not recorded')}
                        </p>
                      </div>
                      <div>
                        <h3 className="text-sm font-medium mb-1">Caught By</h3>
                        <p>{catchItem.user?.username || 'Unknown'}</p>
                      </div>
                      <div>
                        <h3 className="text-sm font-medium mb-1">Caught On</h3>
                        <p>{formatDate(catchItem.catchDate)}</p>
                      </div>
                    </div>
                    ...
                    {catchItem.comments && (
                      <div>
                        ...
                        <p className="text-sm">{catchItem.comments}</p>
                      </div>
                    )}
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                      {!catchItem.isVerified && (
                        <Button 
                          onClick={() => {
                            handleVerifyCatch(catchItem.id);
                      ...
                      <Button 
                        variant="destructive"
                        onClick={() => {
                          handleDeleteCatch(catchItem.id);
                          setSelectedCatchId(null);
                        }}
                      >
